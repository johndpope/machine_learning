...
https://github.com/kei-s/chainer-ptb-nsteplstm/blob/master/train_ptb_nstep.py
"""
...
def main():
    ...
    optimizer = chainermn.create_multi_node_optimizer(
        chainer.optimizers.SGD(lr=1.0), comm)
    ...
    bpttevaluator = BPTTEvaluator(val_iter, eval_model, device=args.gpu)
    bpttevaluator = chainermn.create_multi_node_evaluator(bpttevaluator, comm)
