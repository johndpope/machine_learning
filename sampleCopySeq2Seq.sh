...
aprun -n 1 -d $OMP_NUM_THREADS python sampleCopySeq2Seq.py --dict ../../data/chat/model/dict.dat --data ../../data/chat/model/chat.dat --mode train --model ../../data/chat/model/copy/copy.model  --epoch 100
